...
class NewsPage extends AbstractPage {
	...
	public function readData() {
		...
		$this->moreNewsList->getConditionBuilder()->add("news.newsID IN (SELECT newsID FROM news".WCF_N."_news_to_category WHERE categoryID IN (?) AND newsID <> ?)", array($this->news->getCategoryIDs(), $this->newsID));
